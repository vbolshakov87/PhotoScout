...
export function TripCard({ plan, onClick, imageUrl }: TripCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="relative w-full rounded-2xl overflow-hidden aspect-[4/5] group border border-white/10 shadow-lg hover:shadow-xl hover:shadow-violet-500/10 hover:border-white/20 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
    >
