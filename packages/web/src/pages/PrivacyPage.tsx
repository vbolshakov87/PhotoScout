  ...
  return (
    <div className="h-full overflow-y-auto bg-background">
      ...
      <div className="p-4 prose prose-invert prose-sm max-w-none">
        ...
        <p className="text-foreground/80 text-sm leading-relaxed">We use your information to:</p>
        <ul className="text-foreground/80 text-sm list-disc pl-5 space-y-1">
        ...
        <ul className="text-foreground/80 text-sm list-disc pl-5 space-y-1">
          ...
          <li>
            <strong>Anthropic (Claude AI):</strong> For AI-powered trip planning and recommendations
          </li>
          <li>
            <strong>Google Imagen:</strong> For generating destination images
          </li>
          <li>
            <strong>Amazon Web Services (AWS):</strong> For hosting and data storage
          </li>
        </ul>
        <p className="text-foreground/80 text-sm leading-relaxed mt-2">
          These services have their own privacy policies. Your conversations may be processed by AI
          providers to generate recommendations, but we do not share your personal information with
          these providers beyond what is necessary to provide the Service.
        </p>
        ...
        <p className="text-foreground/80 text-sm leading-relaxed">
          Your data is stored securely on Amazon Web Services (AWS) infrastructure in the EU
          (Frankfurt). We implement industry-standard security measures including encryption in
          transit and at rest to protect your information from unauthorized access.
        </p>
        ...
        <p className="text-foreground/80 text-sm leading-relaxed mt-2">
          We do not use third-party tracking cookies or analytics cookies. We do not sell your data
          to advertisers.
        </p>

        <h2 className="text-foreground text-lg font-semibold mt-6 mb-3">9. Children's Privacy</h2>
        <p className="text-foreground/80 text-sm leading-relaxed">
          PhotoScout is not intended for children under 16 years of age. We do not knowingly collect
        ...
        <p className="text-foreground/80 text-sm leading-relaxed">
          Your data is primarily stored in the EU. Some third-party services (like AI providers) may
          process data in other regions. We ensure appropriate safeguards are in place for any
