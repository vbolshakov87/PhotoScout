...
const INTEREST_KEYWORDS = [
  'architecture', 'cityscape', 'cityscapes',
  'golden hour', 'sunrise', 'sunset', 'landscape', 'landscapes',
  'street', 'street photography', 'local life', 'people',
  'night', 'night photography', 'city lights', 'blue hour',
  'seascape', 'coastal', 'beach', 'ocean',
  'nature', 'wildlife', 'forest', 'mountains',
  'portrait', 'food', 'macro',
];
...
const DESTINATIONS = [
  // Cities
  'tokyo', 'paris', 'new york', 'london', 'rome', 'barcelona', 'amsterdam',
  'berlin', 'vienna', 'prague', 'lisbon', 'copenhagen', 'stockholm', 'oslo',
  'bergen', 'dubai', 'singapore', 'hong kong', 'sydney', 'melbourne',
  'san francisco', 'los angeles', 'chicago', 'miami', 'boston', 'vancouver',
  'toronto', 'montreal', 'rio de janeiro', 'buenos aires', 'cape town',
  'marrakech', 'istanbul', 'athens', 'florence', 'venice', 'munich',
  'zurich', 'brussels', 'dublin', 'hamburg', 'dresden', 'cologne',
  // Nature
  'dolomites', 'swiss alps', 'scottish highlands', 'lofoten', 'norwegian fjords',
  'lake bled', 'tuscany', 'amalfi coast', 'cinque terre', 'provence', 'santorini',
  'iceland', 'faroe islands', 'lake como', 'plitvice lakes',
  'black forest', 'saxon switzerland', 'bavarian alps', 'rhine valley',
  'banff', 'yosemite', 'grand canyon', 'antelope canyon', 'monument valley',
  'big sur', 'hawaii', 'yellowstone', 'patagonia', 'torres del paine',
  'bali', 'ha long bay', 'zhangjiajie', 'maldives', 'new zealand',
  'milford sound', 'mount fuji', 'guilin', 'great barrier reef',
  'sahara', 'serengeti', 'victoria falls', 'namib desert', 'cappadocia',
];
